...
private val COUNTRY_METHODS: Map<String, Pair<Method, Madhab>> =
    mapOf(
        ...
        "YE" to (Method.UMM_AL_QURA to Madhab.SHAFI),
        "KW" to (Method.UMM_AL_QURA to Madhab.SHAFI),
        "QA" to (Method.UMM_AL_QURA to Madhab.SHAFI),
        "OM" to (Method.UMM_AL_QURA to Madhab.SHAFI),
        "BH" to (Method.UMM_AL_QURA to Madhab.SHAFI),
        "JO" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "PS" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "SY" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "LB" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "IQ" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "MA" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "DZ" to (Method.EGYPTIAN to Madhab.SHAFI),
        "TN" to (Method.EGYPTIAN to Madhab.SHAFI),
        "LY" to (Method.EGYPTIAN to Madhab.SHAFI),
        "SD" to (Method.EGYPTIAN to Madhab.SHAFI),
        "SO" to (Method.EGYPTIAN to Madhab.SHAFI),
        "UZ" to (Method.KARACHI to Madhab.HANAFI),
        "AZ" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
        "DE" to (Method.MUSLIM_WORLD_LEAGUE to Madhab.SHAFI),
    )
